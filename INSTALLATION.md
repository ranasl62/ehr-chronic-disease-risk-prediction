...
- `API_ENDPOINT` — optional; bake absolute API base into the web image/build (leave empty for same-origin `/v1`). Hosted example: `https://ehr-risk-framework.larucare.com`
